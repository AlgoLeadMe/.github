## 🌟 반갑습니다! 비대면 알고리즘 스터디 AlgoLeadMe 알고리드미입니다!


<br>

**알고리즘에 대한 감각을 잃지 않음을 목표** 로 하는 알고리즘 스터디 입니다.
...
또한, 인원 수가 많아짐에 따라 소속감과 부담감이 내려가기 때문에 3~4명이 적당해요.
...
딱히 풀만한 문제가 없으시다면, [솔브드 CLASS](https://solved.ac/class), [프로그래머스 고득점 Kit](https://school.programmers.co.kr/learn/challenges?tab=algorithm_practice_kit) 추천드립니다!
...
- 스터디를 시작한 날짜로부터 **3일에 1문제**씩 제출합니다. (팀 합의를 통해 자유롭게 설정하실 수 있습니다.)

<br>

- 다른 참가자들은 **다음 제출일이 되기 전까지 다른 참가자들의 코드를 리뷰** 합니다.

<br>

- 코드 리뷰에 대해 **일방적인 비난은 절대 No. 😢  건강한 토론은 Yes! 😊**
...
아래 **Wiki** 에서 **Git 설치부터 PR 작성, 리드미 작성, 코드 리뷰** 하는 방법에 대한 **모든 내용**을 보실 수 있습니다.
